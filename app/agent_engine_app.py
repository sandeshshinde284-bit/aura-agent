...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-aura-remediation-agent-logs-data"
    ...
    agent_config = {
        ...
        "description": "Aura - Autonomous Remediation & Unification Agent that transforms cloud alerts into automated fixes using AI",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--agent-name",
        default="aura-remediation-agent",
